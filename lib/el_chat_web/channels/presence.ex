defmodule ElChatWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule ElChat.MyChannel do
        use ElChatWeb, :channel
        alias ElChat.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :el_chat,
                        pubsub_server: ElChat.PubSub
end
